      ...
      <div className="container mx-auto px-6 lg:px-12">
        <div className="grid md:grid-cols-5 gap-8">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="/for-clubs" className="text-foreground/70 hover:text-primary transition-colors">
                  For Clubs
                </a>
              </li>
              <li>
                <a href="/investors" className="text-foreground/70 hover:text-primary transition-colors">
                  For Investors
                </a>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-6 border-t border-border">
          <div className="flex flex-wrap gap-4 mb-6">
            ...
            <a href="/imprint" className="text-xs text-muted-foreground hover:text-primary transition-colors">
              {copy.footer.legalLinks.imprint}
            </a>
            <a href="/cookie-policy" className="text-xs text-muted-foreground hover:text-primary transition-colors">
